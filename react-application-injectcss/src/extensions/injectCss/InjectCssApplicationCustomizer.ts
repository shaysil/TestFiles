...
export default class InjectCssApplicationCustomizer
  ...
  public onInit(): Promise<void> {
    ...
    const cssUrl: string = this.context.pageContext.web.absoluteUrl +'/SiteAssets/Css/custom.css'   /*this.properties.cssurl*/;
    const csselemUrl: string = this.properties.cssurl;
