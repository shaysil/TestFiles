...
var InjectCssApplicationCustomizer = (function (_super) {
    ...
    InjectCssApplicationCustomizer.prototype.onInit = function () {
        ...
        var cssUrl = this.context.pageContext.web.absoluteUrl + '/SiteAssets/Css/custom.css' /*this.properties.cssurl*/;
        var csselemUrl = this.properties.cssurl;
        if (csselemUrl) {
            // inject the style sheet
            var head = document.getElementsByTagName("head")[0] || document.documentElement;
            var customStyle = document.createElement("link");
            customStyle.href = csselemUrl;
